...
const s = {
  ...
  card: { background: "white", padding: 40, borderRadius: 16, boxShadow: "0 4px 24px rgba(0,0,0,0.08)", width: 400 },
  ...
  select: { width: "100%", padding: "10px 14px", borderRadius: 8, border: "1.5px solid #e2e8f0", fontSize: 14, marginBottom: 16, background: "white" },
  ...
  return (
    <div style={s.page}>
      <div style={s.card}>
        ...
        <p style={s.sub}>Join Team Task Manager</p>
